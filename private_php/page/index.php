...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col"><h5 class="text-info">Idolm.art (ไอดอลมาร์ต) คือร้านค้าออนไลน์ที่จำหน่ายสินค้าไอดอลวงต่างๆ เช่น BNK48, Sweat16! เพื่อความสะดวกท่านสามารถติดตามข่าวสารได้ที่<a href="https://facebook.com/page.idolm.art/" target="_blank">แฟนเพจของเรา</a> และเพื่อความมั่นใจในการจับจ่ายใช้สอยของท่าน สามารถตรวจสอบได้ที่<a href="/about/" target="_blank">ข้อมูลร้านของเรา</a></h5></div>
			</div>
			<div class="row">
				<div class="col-12 pl-0 pr-0">
								...
								<div class="col-12 col-md-6 col-xl-4 mt-3 text-center">
									<a href="/product/<?=$rec['product_code']?>/" class="text-dark">
										<div class="product_box">
											<div class="row">
												<div class="col-auto">
													<div class="img_bg_cov wh120px" style="background-image: url('/assets/img/product/s_<?=$rec['picture_file']?>');"></div>
												</div>
												<div class="col">
													<div class="row h-75">
														<h5 class="mt-2">
